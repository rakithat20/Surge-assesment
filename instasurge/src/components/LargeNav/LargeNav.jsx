  ...
  return (
    <div className="w-full h-full relative">
        ...
        <Link to='/' className="mb-10 px-2 lg:hidden md:block sm:block block ">
            <img src={InstagramIcon} alt="instagram logo" className="img w-10 h-auto"></img>
        </Link>
        <div className="w-full h-auto flex items-start flex-col gap-y-2">
            <Link to='/' className="w=full h-auto flex items-center gap-x-4 p-3 bg-transparent hover:bg-gray-800/60 rounded-md
            ...
            {sidebarItems.map((item)=>(<Link key={item.name}
                to={item.link}
