    ...
    <>
      {instagramFeed.map((post) => (
        <div className="w-full h-auto mb-6" key={post.id}>
          ...
          <div className="w-full h-auto flex justify-between items-center mb-2">
            <div className="flex items-center gap-x-2">
              <Link className="flex items-center justify-center flex-col flex-shrink-0">
                <div
                  key={post.id}
                  className="w-10 h-10 rounded-full object-cover p-[2px] bg-gradient-to-r from-[#f02aa6] to-[#ff6f48]"
                >
                  <img
                    src={post.profileImg}
                    alt={post.profileImg}
          ...
          {/*post image*/}
          <div
            className="w-full lg:max-h-[75vh] md:max-h-[70vh] sm:max-h-[65vh] max-h-[50vh] lg:h-[70vh] md:h-[60vh] sm:h-[50vh] h-[50vh] 
          lg:min-h-[65vh] md:min-h-[55vh] sm-min-h-[50vh] min-h-[45vh] border border-gray-300 rounded overflow-hidden mb-3"
          >
            <img
              src={post.postImg}
              alt={post.caption}
